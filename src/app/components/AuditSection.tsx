  ...
  return (
    <div className={cn("w-full py-20", className)}>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-black/40 border border-[#A1FFFF]/20 rounded-lg p-8 relative overflow-hidden group hover:border-[#A1FFFF]/40 transition-all duration-300">
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-[#A1FFFF]/20 to-[#F1A3A1]/20 rounded-lg flex items-center justify-center border border-[#A1FFFF]/20">
                <span className="text-[#A1FFFF] font-bold text-lg">✓</span>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-white">OtterSec</h3>
                <p className="text-[#A1FFFF] text-sm font-medium">
                  Completed • Q2 2025
                </p>
              </div>
            </div>
            <span className="bg-gradient-to-r from-[#A1FFFF]/20 to-[#F1A3A1]/20 text-[#A1FFFF] px-3 py-1 rounded-full text-sm font-medium border border-[#A1FFFF]/20">
              Passed
            </span>
          </div>
