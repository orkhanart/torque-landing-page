  ...
  return (
    <div className="relative flex flex-col items-center justify-center gap-4 w-full min-h-[500px]">
      ...
      <div className="flex flex-col items-center justify-start gap-4 z-50 pb-24 px-4">
        <div className="backdrop-blur-sm bg-black/20 rounded-3xl px-8 py-6 mb-8">
          <h1 className="text-4xl sm:text-3xl lg:text-5xl font-medium mb-4 text-center max-w-[900px] md:leading-56 font-sans">
            Join our{" "}
