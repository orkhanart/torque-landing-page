    ...
    return (
      <div className="relative inline-flex items-center group">
        ...
        <div className="flex flex-col">
          <div
            className={cn(
              "w-[10px] bg-primary group-hover:bg-primary-hover transition-colors",
              rectangleHeight
            )}
          />
          <svg
        ...
        >
          <Button
            ...
            className={cn(
              buttonHeight,
              "rounded-none px-2 py-2 !bg-primary !shadow-none group-hover:!bg-primary-hover transition-colors !font-semibold",
              className
            )}
            {...props}
          >
